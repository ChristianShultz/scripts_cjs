#!/bin/tcsh -x
#PBS -N dt28u_rr_improvement_16c16
#PBS -q ib
#PBS -A Spectrum
...
set list="sdb.list"
set run_script="${PBS_O_WORKDIR}/drive_3pt_redstar.improvement.pl"
set dt=28
...
while ($nn < $chunk)
  ...
  set de = `date`
  echo "Ending chroma script at time= $de" 
...
if ($?PBS_O_WORKDIR != 0) then
  /usr/local/bin/qsub ib.16c16.npt.csh
endif
