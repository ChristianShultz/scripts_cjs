...
$b_proj4_p000_T1->quark_model_assignment(QuarkModelAssign::qm_assign("1P1"));
...
$b_proj4_p100_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D4A2P_mom1");
$b_proj4_p100_H0D4A2->t0(9);
$b_proj4_p100_H0D4A2->state(0); 
$b_proj4_p100_H0D4A2->tz(11);
...
$b_proj4_p100_H1D4E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D4E2P_mom1");
$b_proj4_p100_H1D4E2->t0(8);
$b_proj4_p100_H1D4E2->state(1); 
$b_proj4_p100_H1D4E2->tz(11);
...
$b_proj4_p110_H0D2A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D2A2P_mom2");
$b_proj4_p110_H0D2A2->t0(8);
$b_proj4_p110_H0D2A2->state(0); 
$b_proj4_p110_H0D2A2->tz(9);
...
$b_proj4_p110_H1D2B1->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D2B1P_mom2");
$b_proj4_p110_H1D2B1->t0(8);
$b_proj4_p110_H1D2B1->state(1); 
$b_proj4_p110_H1D2B1->tz(10);
...
$b_proj4_p110_H1D2B2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D2B2P_mom2");
$b_proj4_p110_H1D2B2->t0(8);
$b_proj4_p110_H1D2B2->state(1); 
$b_proj4_p110_H1D2B2->tz(9);
...
$b_proj4_p111_H0D3A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D3A2P_mom3");
$b_proj4_p111_H0D3A2->t0(8);
$b_proj4_p111_H0D3A2->state(0); 
$b_proj4_p111_H0D3A2->tz(13);
...
$b_proj4_p111_H1D3E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D3E2P_mom3");
$b_proj4_p111_H1D3E2->t0(7);
$b_proj4_p111_H1D3E2->state(2); 
$b_proj4_p111_H1D3E2->tz(11);
...
$b_proj4_p200_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D4A2P_mom4");
$b_proj4_p200_H0D4A2->t0(8);
$b_proj4_p200_H0D4A2->state(0); 
$b_proj4_p200_H0D4A2->tz(9);
...
$b_proj4_p200_H1D4E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D4E2P_mom4");
$b_proj4_p200_H1D4E2->t0(7);
$b_proj4_p200_H1D4E2->state(1); 
$b_proj4_p200_H1D4E2->tz(10);
