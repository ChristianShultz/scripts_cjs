...
my @all_ops = (); 
  ...
  $rho_proj3_p000_T1->t0(7);
  $rho_proj3_p000_T1->state(2); 
  ...
  $rho_proj3_p100_H0D4A1->state(3); 
  $rho_proj3_p100_H0D4A1->tz(18);
  $rho_proj3_p100_H0D4A1->phaser(1.);
  $rho_proj4_p100_H0D4A1->hybrid(1.);
