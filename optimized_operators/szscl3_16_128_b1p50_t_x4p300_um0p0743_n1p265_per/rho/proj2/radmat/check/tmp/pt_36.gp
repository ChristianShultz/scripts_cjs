...
f = (t/l)*(t/l) 
g(x) = m*m + (f/(a*a))*x
fit g(x) 'tmp/dat_36.dat' using 1:2 via m,a 
plot 'tmp/dat_36.dat' using 1:2:3 w yerr ti 'E^2(p^2)' lt 5, \
...
replot 
set term x11 1
plot 'tmp/dat_36.dat' using 1:(sqrt($2)):3 w yerr ti 'E(p^2)' lt 5, \
