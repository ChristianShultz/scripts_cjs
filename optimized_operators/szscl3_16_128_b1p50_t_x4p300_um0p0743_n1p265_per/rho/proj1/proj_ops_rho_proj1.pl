...
my @all_ops = (); 
  ...
  $rho_proj1_p000_T1->t0(7);
  $rho_proj1_p000_T1->state(0); 
  $rho_proj1_p000_T1->tz(19);
  ...
  $rho_proj1_p100_H1D4E2->state(0); 
  $rho_proj1_p100_H1D4E2->tz(16);
  ...
  $rho_proj1_p110_H0D2A1->state(0); 
  $rho_proj1_p110_H0D2A1->tz(16);
  ...
  $rho_proj1_p110_H1D2B1->state(0); 
  $rho_proj1_p110_H1D2B1->tz(14);
  ...
  $rho_proj1_p110_H1D2B2->t0(9);
  $rho_proj1_p110_H1D2B2->state(0); 
  $rho_proj1_p110_H1D2B2->tz(17);
  ...
  $rho_proj1_p111_H0D3A1->state(0); 
  $rho_proj1_p111_H0D3A1->tz(15);
  ...
  $rho_proj1_p111_H1D3E2->state(0); 
  $rho_proj1_p111_H1D3E2->tz(14);
  ...
  $rho_proj1_p200_H0D4A1->state(0); 
  $rho_proj1_p200_H0D4A1->tz(15);
  ...
  $rho_proj1_p200_H1D4E2->state(0); 
  $rho_proj1_p200_H1D4E2->tz(16);
