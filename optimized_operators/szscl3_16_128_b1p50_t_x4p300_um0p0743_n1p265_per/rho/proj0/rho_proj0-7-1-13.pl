...
my @all_ops = (); 
  ...
  $rho_proj0_p100_H0D4A1->t0(9);
  $rho_proj0_p100_H0D4A1->state(0); 
  $rho_proj0_p100_H0D4A1->tz(13);
  ...
  $rho_proj0_p100_H1D4E2->t0(8);
  $rho_proj0_p100_H1D4E2->state(0); 
  $rho_proj0_p100_H1D4E2->tz(11);
  ...
  $rho_proj0_p110_H1D2B2->t0(8);
  $rho_proj0_p110_H1D2B2->state(0); 
  $rho_proj0_p110_H1D2B2->tz(9);
  ...
  $rho_proj0_p200_H1D4E2->t0(7);
  $rho_proj0_p200_H1D4E2->state(0); 
  $rho_proj0_p200_H1D4E2->tz(10);
