...
#  $a_proj3_p100_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p100_H0D4A2->t0(-1);
#  $a_proj3_p100_H0D4A2->state(-1); 
#  $a_proj3_p100_H0D4A2->tz(-1);
...
#  $a_proj3_p100_H1D4E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p100_H1D4E2->t0(-1);
#  $a_proj3_p100_H1D4E2->state(-1); 
#  $a_proj3_p100_H1D4E2->tz(-1);
...
#  $a_proj3_p110_H0D2A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p110_H0D2A2->t0(-1);
#  $a_proj3_p110_H0D2A2->state(-1); 
#  $a_proj3_p110_H0D2A2->tz(-1);
...
#  $a_proj3_p110_H1D2B1->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p110_H1D2B1->t0(-1);
#  $a_proj3_p110_H1D2B1->state(-1); 
#  $a_proj3_p110_H1D2B1->tz(-1);
...
#  $a_proj3_p110_H1D2B2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p110_H1D2B2->t0(-1);
#  $a_proj3_p110_H1D2B2->state(-1); 
#  $a_proj3_p110_H1D2B2->tz(-1);
...
#  $a_proj3_p111_H0D3A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p111_H0D3A2->t0(-1);
#  $a_proj3_p111_H0D3A2->state(-1); 
#  $a_proj3_p111_H0D3A2->tz(-1);
...
#  $a_proj3_p111_H1D3E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p111_H1D3E2->t0(-1);
#  $a_proj3_p111_H1D3E2->state(-1); 
#  $a_proj3_p111_H1D3E2->tz(-1);
...
#  $a_proj3_p200_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p200_H0D4A2->t0(-1);
#  $a_proj3_p200_H0D4A2->state(-1); 
#  $a_proj3_p200_H0D4A2->tz(-1);
...
#  $a_proj3_p200_H1D4E2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/");
#  $a_proj3_p200_H1D4E2->t0(-1);
#  $a_proj3_p200_H1D4E2->state(-1); 
#  $a_proj3_p200_H1D4E2->tz(-1);
