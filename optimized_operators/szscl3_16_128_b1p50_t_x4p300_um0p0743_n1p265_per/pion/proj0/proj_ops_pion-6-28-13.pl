...
my @all_ops = (); 
  ...
  $pion_proj0_p000_A1->quark_model_assignment(QuarkModelAssign::qm_assign("1S0"));
  ...
  $pion_proj0_p110_H0D2A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D2A2M_mom2");
  ...
  &make_proj_plots(\@list_extracts,"pion_proj0"); 
