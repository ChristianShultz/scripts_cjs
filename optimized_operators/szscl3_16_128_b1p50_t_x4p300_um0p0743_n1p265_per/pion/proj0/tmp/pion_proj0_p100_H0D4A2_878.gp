...
set title "pion_proj0_p100_H0D4A2" 
unset key 
...
plot "tmp/pion_proj0_p100_H0D4A2_878_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p100_H0D4A2_878_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj0_p100_H0D4A2.eps" 
replot