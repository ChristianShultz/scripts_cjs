...
plot "tmp/pion_proj0_p110_H0D2A2_390_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p110_H0D2A2_390_.dat" u (column(0)):($2 + 0.02):4 with labels
