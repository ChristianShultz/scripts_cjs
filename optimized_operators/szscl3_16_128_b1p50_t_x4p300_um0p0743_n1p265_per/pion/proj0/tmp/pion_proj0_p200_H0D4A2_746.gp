...
plot "tmp/pion_proj0_p200_H0D4A2_746_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p200_H0D4A2_746_.dat" u (column(0)):($2 + 0.02):4 with labels
