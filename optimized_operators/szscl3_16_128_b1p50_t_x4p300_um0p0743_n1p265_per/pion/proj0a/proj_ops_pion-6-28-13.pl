...
my @all_ops = (); 
  ...
  $pion_proj0_p110_H0D2A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl3_16_128_b1p50_t_x4p300_um0p0743_n1p265_per/redstar/isovector/analysis/shultz/D2A2M_mom2.t0_0.9-3-13-corrs");
  $pion_proj0_p110_H0D2A2->t0(8);
