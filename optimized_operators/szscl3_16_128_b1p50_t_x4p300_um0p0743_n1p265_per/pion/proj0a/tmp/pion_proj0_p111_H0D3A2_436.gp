...
set title "pion_proj0_p111_H0D3A2" 
unset key 
...
plot "tmp/pion_proj0_p111_H0D3A2_436_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p111_H0D3A2_436_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj0_p111_H0D3A2.eps" 
replot