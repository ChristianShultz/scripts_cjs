...
set title "pion_proj4_p110_H0D2A1" 
unset key 
...
plot "tmp/pion_proj4_p110_H0D2A1_863_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj4_p110_H0D2A1_863_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj4_p110_H0D2A1.eps" 
replot