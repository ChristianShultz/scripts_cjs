...
set title "pion_proj4_p110_H1D2B2" 
unset key 
...
plot "tmp/pion_proj4_p110_H1D2B2_863_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj4_p110_H1D2B2_863_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj4_p110_H1D2B2.eps" 
replot