...
set title "pion_proj4_p100_H1D4E2" 
unset key 
...
plot "tmp/pion_proj4_p100_H1D4E2_863_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj4_p100_H1D4E2_863_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj4_p100_H1D4E2.eps" 
replot