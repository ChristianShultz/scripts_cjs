...
set object 6 rect from screen 0.90,0.35 to screen 0.95,0.40 fc lt 5 
set object 7 rect from screen 0.90,0.25 to screen 0.95,0.30 fc lt 6 
set object 8 rect from screen 0.90,0.15 to screen 0.95,0.20 fc lt 7 
...
plot "tmp/pion_proj4_p000_T1_863_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj4_p000_T1_863_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj4_p000_T1.eps" 
replot
