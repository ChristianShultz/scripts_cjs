...
my @all_ops = (); 
  ...
  $pion_proj4_p100_H1D4E2->t0(4);
  $pion_proj4_p100_H1D4E2->state(5); 
  $pion_proj4_p100_H1D4E2->tz(7);
  ...
  $pion_proj4_p110_H0D2A1->t0(6);
  $pion_proj4_p110_H0D2A1->state(4); 
  $pion_proj4_p110_H0D2A1->tz(8);
  ...
  $pion_proj4_p110_H1D2B1->t0(5);
  $pion_proj4_p110_H1D2B1->state(3); 
  $pion_proj4_p110_H1D2B1->tz(7);
  ...
  $pion_proj4_p111_H0D3A1->t0(4);
  $pion_proj4_p111_H0D3A1->state(2); 
  $pion_proj4_p111_H0D3A1->tz(10);
  ...
  $pion_proj4_p111_H1D3E2->t0(5);
  $pion_proj4_p111_H1D3E2->state(5); 
  $pion_proj4_p111_H1D3E2->tz(8);
  ...
  $pion_proj4_p200_H0D4A1->t0(4);
  $pion_proj4_p200_H0D4A1->state(2); 
  $pion_proj4_p200_H0D4A1->tz(10);
  ...
  $pion_proj4_p200_H1D4E2->t0(5);
  $pion_proj4_p200_H1D4E2->state(3); 
  $pion_proj4_p200_H1D4E2->tz(9);
