...
plot "tmp/pion_proj0_p100_H0D4A2_125_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p100_H0D4A2_125_.dat" u (column(0)):($2 + 0.02):4 with labels
