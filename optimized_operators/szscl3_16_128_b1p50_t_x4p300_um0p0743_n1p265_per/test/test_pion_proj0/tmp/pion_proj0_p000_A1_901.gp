...
plot "tmp/pion_proj0_p000_A1_901_.dat" u (column(0)):2:(0.5):($3):xtic(1) w boxes lc variable, \
"tmp/pion_proj0_p000_A1_901_.dat" u (column(0)):($2 + 0.02):4 with labels
set terminal postscript eps 
set output "pion_proj0_p000_A1.eps" 
replot