...
my @all_ops = (); 
  ...
  $rho_proj0_p000_T1->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265_per/redstar/rho600/rho_ff/T1mm");
  $rho_proj0_p000_T1->t0(10);
  $rho_proj0_p000_T1->state(0); 
  $rho_proj0_p000_T1->tz(12);
  $rho_proj0_p000_T1->phaser(1.);
  $rho_proj0_p000_T1->recon_version("two_particle"); 
  $rho_proj0_p000_T1->nested(["rho.rest.xml","pipi_I1.rest.xml"]); 
