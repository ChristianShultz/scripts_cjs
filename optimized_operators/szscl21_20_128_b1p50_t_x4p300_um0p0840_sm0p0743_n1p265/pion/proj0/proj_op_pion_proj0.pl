...
my @all_ops = (); 
  ...
  $pion_proj0_p000_A1->ncfg(603);
  $pion_proj0_p000_A1->ensemble("szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265"); 
  $pion_proj0_p000_A1->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265/meson_2pt/");
  $pion_proj0_p000_A1->t0(-1);
  $pion_proj0_p000_A1->state(-1); 
  $pion_proj0_p000_A1->tz(-1);
  ...
  $pion_proj0_p100_H0D4A2->ncfg(603);
  $pion_proj0_p100_H0D4A2->ensemble("szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265"); 
  $pion_proj0_p100_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265/meson_2pt/");
  $pion_proj0_p100_H0D4A2->t0(-1);
  $pion_proj0_p100_H0D4A2->state(-1); 
  $pion_proj0_p100_H0D4A2->tz(-1);
  ...
  $pion_proj0_p110_H0D2A2->ncfg(603);
  $pion_proj0_p110_H0D2A2->ensemble("szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265"); 
  $pion_proj0_p110_H0D2A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265/meson_2pt/");
  $pion_proj0_p110_H0D2A2->t0(-1);
  $pion_proj0_p110_H0D2A2->state(-1); 
  $pion_proj0_p110_H0D2A2->tz(-1);
  ...
  $pion_proj0_p111_H0D3A2->ncfg(603);
  $pion_proj0_p111_H0D3A2->ensemble("szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265"); 
  $pion_proj0_p111_H0D3A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265/meson_2pt/");
  $pion_proj0_p111_H0D3A2->t0(-1);
  $pion_proj0_p111_H0D3A2->state(-1); 
  $pion_proj0_p111_H0D3A2->tz(-1);
  ...
  $pion_proj0_p200_H0D4A2->ncfg(603);
  $pion_proj0_p200_H0D4A2->ensemble("szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265"); 
  $pion_proj0_p200_H0D4A2->recon_dir("/work/JLabLQCD/LHPC/Spectrum/Clover/NF2+1/szscl21_20_128_b1p50_t_x4p300_um0p0840_sm0p0743_n1p265/meson_2pt/");
  $pion_proj0_p200_H0D4A2->t0(-1);
  $pion_proj0_p200_H0D4A2->state(-1); 
  $pion_proj0_p200_H0D4A2->tz(-1);
